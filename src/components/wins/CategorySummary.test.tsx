...
describe('CategorySummary', () => {
  ...
  it('returns null when all wins share the same category (single group)', () => {
    const wins = [
      { id: '1', title: 'A', category: 'work', completed: false },
      { id: '2', title: 'B', category: 'work', completed: true },
    ];
  ...
  it('renders correct counts for multi-category wins', () => {
    const wins = [
      { id: '1', title: 'Write report', category: 'work', completed: true },
      { id: '2', title: 'Code review', category: 'work', completed: false },
      { id: '3', title: 'Gym', category: 'health', completed: false },
    ];
  ...
  it('handles wins with missing category (falls back to work)', () => {
    const wins = [
      { id: '1', title: 'No category win', completed: true },
      { id: '2', title: 'Personal win', category: 'personal', completed: false },
    ];
    render(<CategorySummary wins={wins} />);
  ...
  it('renders all three categories when wins span work, personal, and health', () => {
    const wins = [
      ...
      { id: '2', title: 'Personal task', category: 'personal', completed: false },
      { id: '3', title: 'Health task', category: 'health', completed: true },
    ];
    render(<CategorySummary wins={wins} />);
